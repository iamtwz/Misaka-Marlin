...
#define STRING_CONFIG_H_AUTHOR "(Misaka, Misaka I3)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Misaka I3"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,400,153}  // default steps per unit for Ultimaker
